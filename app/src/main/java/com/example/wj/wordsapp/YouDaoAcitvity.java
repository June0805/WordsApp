...
public class YouDaoAcitvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_you_dao_acitvity);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (item != null) {
                    ...
                    Toast.makeText(YouDaoAcitvity.this, "更新单词本成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
